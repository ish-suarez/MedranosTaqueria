  ...
  return (
    <div className='w-full'>
      <Head>
        ...
        <meta name="description" content="Medrano's Taqueria brings you fresh and authentic flavors from our culture, to you, in Katy, Texas. Your favorite street taco spot. Monday - Saturday: 6AM - 10PM" />
        <meta name="keywords" content="Tacos, Quesadillas, Burritos, Street Tacos, Taco Truck, Culture, Caldos, Sopes, Medrano's, Taqueira, Katy" />
      </Head>
      {/* Home page Content */}
        ...
        <div className=" mt-[20vh] sm:mt-[20vh] py-10 flex flex-col">
          <div className={`${styles.ani}`}>
            <div className="flex relative flex-col max-w-md sm:ml-20 xl:max-w-2xl xl:ml-40">
                ...
                <div className="flex relative ml-20 w-64 md:w-full text-center space-x-2 my-3 text-lg md:text-xl lg:text-2xl font-bold text-green-50">
